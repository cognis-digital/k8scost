"""K8SCOST command-line interface."""
from __future__ import annotations
import argparse, sys
from k8scost.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="k8scost", description="K8SCOST — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from k8scost.mcp_server import serve
        return serve()
    if args.cmd == "scan":
