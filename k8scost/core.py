"""K8SCOST core — Kubernetes cost and rightsizing advisor with no Prometheus dependency."""
...
RULES = [
    ("K8S-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("K8S-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("K8S-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
